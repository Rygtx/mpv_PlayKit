...
PAYLOAD_SIZE = 512
PAYLOAD_MAGIC = 0x414C5344  # "DSLA" (v10, 版本位走 hex: 9 之后是 A)
...
# nvofFollowScaling,fgEnabled,fgMultiplier,fgRouter,fgBackend
...
DEFAULTS = dict(
    ...
    fgEnabled=0, fgMultiplier=2, fgRouter=0, fgBackend=0,
)
